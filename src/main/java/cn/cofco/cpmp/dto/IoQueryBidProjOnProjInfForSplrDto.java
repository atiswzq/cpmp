...
/**
 * Created by Xujy on 2017/5/20.
 * for [供应商根据条件分页查询线上招标项目信息 - 上送栏位DTO] in cpmp
 */
public class IoQueryBidProjOnProjInfForSplrDto {
    ...
    public String toString() {
        return "IoQueryBidProjOnProjInfForSplrDto{" +
                "projId=" + projId +
                ", projNbr='" + projNbr + '\'' +
                ", projNam='" + projNam + '\'' +
                ", projRsps='" + projRsps + '\'' +
