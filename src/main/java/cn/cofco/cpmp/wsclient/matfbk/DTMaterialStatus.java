...
/**
 * <p>DT_MaterialStatus complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="DT_MaterialStatus"&gt;
 *   &lt;complexContent&gt;
 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="MATCODE" type="{http://www.w3.org/2001/XMLSchema}string"/&gt;
...
@XmlType(name = "DT_MaterialStatus", propOrder = {
    "feedback"
})
public class DTMaterialStatus {

    @XmlElement(name = "FEEDBACK", required = true)
	public List<DTMaterialStatus.FEEDBACK> feedback;
     ...
     * {@link DTMaterialStatus.FEEDBACK }
     * 
     * 
     */
    public List<DTMaterialStatus.FEEDBACK> getFEEDBACK() {
        if (feedback == null) {
            feedback = new ArrayList<DTMaterialStatus.FEEDBACK>();
        }
    ...
    public static class FEEDBACK {
        ...
        @XmlElement(name = "MATCODE", required = true)
